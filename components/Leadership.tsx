        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {t.leadership.team.map((member, idx) => (
                <motion.div
                    ...
                    whileHover={{ y: -10 }}
                    className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-10 rounded-[2rem] flex flex-col items-start relative overflow-hidden group hover:border-medical-500/50 dark:hover:border-medical-900 transition-colors shadow-lg shadow-slate-200/50 dark:shadow-none"
                >
                    {/* Hover Glow */}
                    <div className="absolute top-0 right-0 w-32 h-32 bg-medical-500/5 dark:bg-medical-500/10 rounded-full blur-[50px] group-hover:bg-medical-500/10 dark:group-hover:bg-medical-500/20 transition-all" />

                    <div className="w-20 h-20 rounded-2xl bg-medical-50 dark:bg-medical-900/30 flex items-center justify-center text-medical-600 dark:text-medical-500 mb-8 border border-medical-100 dark:border-medical-500/20">
